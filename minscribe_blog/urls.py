...
urlpatterns = [
    ...
    path('posts/<slug:slug>/collaborators/', views.CollaborationResponseView.as_view(), name='collaborator-list'),
    path('posts/<slug:slug>/collaborators/create/', views.CollaborativeEditView.as_view(), name='create-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/', views.CollaborationResponseView.as_view(), name='collaborator-detail'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/edit/', views.CollaborativeEditView.as_view(), name='edit-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/delete/', views.CollaborativeEditView.as_view(), name='delete-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/like/', views.CollaborativeEditView.as_view(), name='like-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/dislike/', views.CollaborativeEditView.as_view(), name='dislike-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/report/', views.CollaborativeEditView.as_view(), name='report-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/accept/', views.CollaborationResponseView.as_view(), name='accept-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/reject/', views.CollaborationResponseView.as_view(), name='reject-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/invite/', views.CollaborationInviteView.as_view(), name='invite-collaborator'),
    path('posts/<slug:slug>/collaborators/<int:collaborator_id>/invite/<int:invite_id>/', views.CollaborationInviteView.as_view(), name='invite-detail'),
